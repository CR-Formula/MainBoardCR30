...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, LED_OUT_Pin|BrakeLight_OUT_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LoRa_CS_Pin|GPS_RST_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin : BrakeLight_OUT_Pin */
